...
(function($) {
   ...
   $(window).load(function() {
	...
	$(".home-slides").vegas({
		...
		delay: 5000,
    	slides: [
            { src: "images/slides/buzowedding.jpg" },
            { src: "images/slides/cassidy.jpg" },
            { src: "images/slides/connor.jpg" },
            { src: "images/slides/cooper.jpg" },
    ...
    $('a#slides-next').on('click', function () {
        $(".home-slides").vegas('next');
    });

    $('a#slides-previous').on('click', function () {
